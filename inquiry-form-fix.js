...
(function(){
  function init(){
    ...
    contact.setAttribute('autocomplete','tel');
    ...
    form.addEventListener('submit',function(e){
      ...
      const inquiry=[
        ...
        'Messenger / Contact: '+contact.value.trim(),
      ...
      if(navigator.clipboard && window.isSecureContext){
        navigator.clipboard.writeText(inquiry).then(function(){
          ...
          window.open('https://m.me/lesliecastroicalla','_blank','noopener,noreferrer');
        }).catch(function(){
          showStatus('Messenger will open next. Please copy the details below before sending.');
          window.open('https://m.me/lesliecastroicalla','_blank','noopener,noreferrer');
        }).finally(function(){
        ...
        helper.value=inquiry; helper.setAttribute('readonly',''); helper.style.position='fixed'; helper.style.opacity='0';
